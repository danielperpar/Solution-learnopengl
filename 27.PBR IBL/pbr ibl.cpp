...
int main()
{
	...
	// -------------------------
	Shader pbrShader("resources/shaders/pbr_ibl.vs", "resources/shaders/pbr_ibl.fs");
	...
	float *data = stbi_loadf("resources/textures/hdr/Road_to_MonumentValley_Ref.hdr", &width, &height, &nrComponents, 0);
