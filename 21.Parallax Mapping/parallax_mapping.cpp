...
int main()
{
	...
	unsigned int diffuseTexture = loadTexture("resources/textures/bricks2.jpg");
	unsigned int normalTexture = loadTexture("resources/textures/bricks2_normal.jpg");
	unsigned int displacementTexture = loadTexture("resources/textures/bricks2_disp.jpg");
	/*
	unsigned int diffuseTexture = loadTexture("resources/textures/wood.png");
	unsigned int normalTexture = loadTexture("resources/textures/toy_box_normal.png");
	unsigned int displacementTexture = loadTexture("resources/textures/toy_box_disp.png");
	*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		shader.SetInt("texture_depth", 2);
		shader.SetFloat("depthScale", 0.1f);
